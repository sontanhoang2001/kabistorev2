...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    include("../helpers/helpers.php");
        $responsePassword = md5ToString($password);
    if ($responsePassword) {
        //goi thu vien
        ...
        <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                    ...
                                    <tr>
                                        <td class="content-cell">
                                            <div class="f-fallback">
                                                <h1>' . $name . ' ơi</h1>
                                                <p>Chúng tôi đã kịp thời hỗ trợ bạn tìm lại mật khẩu đăng nhập mua sắm tại
                                                    kabistore
                                                    . Bạn hãy giữ mật khẩu cận thận nhé. </p>

                                                    <div>
                                                    <strong>Tên đăng nhập: ' . $username . '</strong>
                                                </div>
                                                <div>
                                                    <strong>Mật khẩu: ' . $responsePassword . '</strong>
                                                </div>
                                                <!-- Action -->
            ...
            https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <a href="http://kabistore.com.vn/login.html"
