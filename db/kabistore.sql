...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 14, 2021 lúc 05:29 AM
...
CREATE TABLE `tbl_product` (
  ...
  `seo` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbl_product` (`productId`, `productName`, `seo`, `product_code`, `productQuantity`, `product_soldout`, `product_remain`, `catId`, `brandId`, `product_desc`, `type`, `old_price`, `price`, `image`) VALUES
