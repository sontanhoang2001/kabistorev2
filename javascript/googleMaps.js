...
if (!document.getElementById('googleMapAPI')) {
    ...
    s.id = 'googleMapAPI';
    s.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAQjGLYTHjDDbPrkhVBpF9oxOEGdrIUj0U&sensor=false&libraries=places&callback=controlMap';
...
function initializeMap() {
    ...
    locationButton.textContent = "Vị trí hiện tại";
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    infoWindow.setContent("Đã tìm thấy vị trí hiện tại của bạn.");
                    infoWindow.open(map);
                    map.setCenter(pos);
                },
                () => {
    ...
    //function displaying User or Device Position on Maps
