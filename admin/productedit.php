                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="old_price" value="<?php echo $result_product['old_price'] ?>" type="text" class="medium" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="select" name="type">
                                        ...
                                        ?>
                                            <option selected value="0">Non-featurered</option>
                                            <option value="1">Featurered</option>
                                        <?php
                                        } else {
                                        ?>
                                            <option value="1">Featurered</option>
